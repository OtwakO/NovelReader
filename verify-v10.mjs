...
const path='testdata/booksource/explore-live-audit-v10-2026-07-23.json';
...
const prior=new Set();for(const name of audit.selection.priorManifests){const j=JSON.parse(fs.readFileSync(`testdata/booksource/${name}`,'utf8'));for(const e of j.entries??[])prior.add(`${e.rawIndex}\0${e.sourceUrl??e.bookSourceUrl}`)}
