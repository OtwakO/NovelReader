...
const importPath = '/tmp/search-bookinfo-v2-import.json';
const initial = JSON.parse(fs.readFileSync('/tmp/search-bookinfo-v2-initial.json', 'utf8'));
const outputPath = '/tmp/search-bookinfo-v2-rerun.json';
...
async function rerun(entry) {
  ...
  return { rawIndex: entry.rawIndex, bookSourceUrl: entry.bookSourceUrl, frozenIndex: entry.frozenIndex, search, selectedResult: selectedResult ?? null, detail };
}
