...
These scripts produce deterministic live evidence for the bounded Search → Book Info audit under `testdata/booksource/audits/search-bookinfo/`. They are evidence tooling, not application runtime code.
