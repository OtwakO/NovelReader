<script lang="ts">
  ...
  $effect(() => {
    ...
    else window.location.hash = '#/sources';
...
<div class="app">
  <header class="app-header">
    ...
    <h1>NovelReader</h1>
    <nav>
      <button class="nav-btn" onclick={() => go('sources')} aria-label="Sources">📚</button>
      <button class="nav-btn" onclick={() => go('search')} aria-label="Search">🔍</button>
      <button class="nav-btn" onclick={() => go('settings')} aria-label="Settings">⚙️</button>
    </nav>
  </header>
