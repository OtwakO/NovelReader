...
@media (max-width: 48rem) {
  ...
  .mobile-management { position: absolute; top: 3.5rem; right: 1rem; width: min(17rem, calc(100vw - 2rem)); display: grid; padding: .5rem; border: 1px solid var(--color-border); border-radius: var(--radius-lg); background: var(--color-paper-raised); box-shadow: var(--shadow-card); }
