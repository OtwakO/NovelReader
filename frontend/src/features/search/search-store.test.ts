...
describe('search store', () => {
  it('ignores late events from a stopped stream', () => {
    ...
    handlers?.onResult('source-a', [{ name: '凡人修仙传', author: '忘语', coverUrl: '', intro: '', kind: '', lastChapter: '', bookUrl: '/a', sourceUrl: 'a', sourceName: 'A' }], 1);
  ...
  it('preserves results and retry cursor after disconnect', () => {
    ...
    handlers?.onResult('a', [{ name: '凡人修仙传', author: '忘语', coverUrl: '', intro: '', kind: '', lastChapter: '', bookUrl: '/a', sourceUrl: 'a', sourceName: 'A' }], 1);
