...
<template>
  <details class="controls">
    <summary>{{ $t('search.controls.title') }}</summary>
...
summary { min-height: 2.75rem; display: flex; align-items: center; padding: .6rem .85rem; color: var(--color-ink-muted); cursor: pointer; font-size: .88rem; font-weight: 700; }
