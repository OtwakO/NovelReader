...
export default defineComponent({
  ...
  methods: {
    async load(retry = false) {
      ...
      this.navigation=null; this.restoring=false; this.loading=true; this.content=null; this.displayContent=null; this.displayChapters=[]; this.navigating=false;
    ...
    async loadContent(index:number,position:number,request?:number,proposal?:ReaderNavigation) {
      ...
      const previous={navigation:this.navigation,currentIndex:this.currentIndex,content:this.content,contentRevision:this.contentRevision,lastPosition:this.lastPosition,displayChapters:this.displayChapters,displayContent:this.displayContent,conversionError:this.conversionError};
      this.restoring=true;
