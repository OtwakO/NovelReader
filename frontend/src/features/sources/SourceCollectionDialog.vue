...
<style scoped>
.overlay{position:fixed;z-index:90;inset:0;display:grid;place-items:center;padding:1rem;background:rgb(0 0 0/.42)}.dialog{width:min(32rem,100%);display:grid;gap:1rem;padding:1rem;border-radius:var(--radius-lg);background:var(--color-paper-raised)}header,footer{display:flex;justify-content:space-between;align-items:center;gap:1rem}h2,p{margin:0}h2{font:var(--weight-strong) var(--text-section) var(--font-literary)}.eyebrow{color:var(--color-warm);font-size:var(--text-caption);font-weight:var(--weight-strong);letter-spacing:.1em;text-transform:uppercase}.mode-tabs{display:grid;grid-template-columns:1fr 1fr;padding:.25rem;border-radius:var(--radius-md);background:var(--color-paper-muted)}.mode-tabs button{min-height:2.5rem;border:0;border-radius:calc(var(--radius-md) - .2rem);background:transparent;color:var(--color-ink-muted);font-weight:var(--weight-strong)}.mode-tabs button.active{background:white;color:var(--color-ink);box-shadow:0 1px 3px rgb(0 0 0/.08)}label{display:grid;gap:.35rem}label span{font-size:var(--text-caption);font-weight:var(--weight-strong)}input,select{min-height:2.75rem;border:1px solid var(--color-border);border-radius:var(--radius-md);padding:.55rem .7rem;background:white;color:var(--color-ink)}.error{color:var(--color-danger)}footer{justify-content:flex-end}@media(max-width:34rem){.overlay{align-items:end;padding:0}.dialog{border-radius:var(--radius-lg) var(--radius-lg) 0 0}}
</style>
