...
<template>
  <section class="runtime-cookies">
    ...
    <div class="app-actions cookie-actions">
...
.cookie-summary, .cookie-editor { display: grid; gap: .65rem; }.cookie-summary article { min-width: 0; display: grid; gap: .3rem; padding: .7rem .8rem; border: 1px solid var(--color-border); border-radius: var(--radius-md); }.cookie-summary strong { overflow-wrap: anywhere; }.cookie-summary span, .empty, .security-note { color: var(--color-ink-muted); font-size: var(--text-small); overflow-wrap: anywhere; }
.cookie-scope, .cookie-scope label, .password-field { display: grid; gap: .35rem; }.cookie-scope { padding: .75rem; border: 1px solid var(--color-border); border-radius: var(--radius-md); }.cookie-scope label > span, .password-field > span { font-weight: var(--weight-strong); }.cookie-scope input, .cookie-scope textarea, .password-field input { width: 100%; min-width: 0; border: 1px solid var(--color-border); border-radius: var(--radius-md); padding: .65rem .7rem; background: white; color: var(--color-ink); font: inherit; }.cookie-scope input, .password-field input { min-height: 2.75rem; }.cookie-scope textarea { resize: vertical; overflow-wrap: anywhere; }
.add-scope, .remove-scope { min-height: 2.75rem; border: 1px solid var(--color-border); border-radius: var(--radius-md); padding: .6rem .75rem; background: transparent; color: var(--color-accent); font-weight: var(--weight-strong); cursor: pointer; }.remove-scope { color: var(--color-danger); text-align: start; }.cookie-actions { justify-content: flex-end; }.cookie-message { padding: .7rem; border-radius: var(--radius-md); background: var(--color-paper-muted); }.cookie-message.error { background: #f8e4df; color: var(--color-danger); }
