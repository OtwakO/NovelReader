...
2. Agree on the smallest complete TXT delivery and necessary shared contracts using the workstream's requirements and quality criteria. Do not inherit its former schema split, file lifecycle machinery, or foundation-first sequence without revalidation.
