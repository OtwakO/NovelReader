...
**Next action:** Continue with JSON object wildcard/filter selection and Jsoup `ownText()` after committing the green executable-header slice. Then verify raw 177/5/503/288 and adjacent corpus users before full checks and review. Do not rewrite stale source contracts.
