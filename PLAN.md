...
[Multi-provider library and imported books](docs/plans/2026-09-10-multi-provider-library.md) — methodical implementation is active. TXT analysis/range reading, per-home snapshot/file-mutation coordination, and composable BookSource catalog transactions are implemented and tested. No import UI, provider-neutral schema, shared reader integration, or publication acquisition/removal is implemented yet. Backup serialization and confirmation of uncertain inbox cleanup are confirmed. Next is the coordinated shared-state cutover followed by durable acquisition; see the plan for boundaries and verification.
