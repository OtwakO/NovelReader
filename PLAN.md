...
1. Continue the [multi-provider library workstream](docs/plans/2026-09-10-multi-provider-library.md#resume-here) at delivery step 2: specify minimum shared state and durable acquisition/removal around the tested TXT interpretation and snapshot coordination boundaries. Resolve consequential choices before schema/lifecycle edits; do not repeat broad reassessment or reopen settled product choices.
