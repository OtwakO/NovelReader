...
**Next action:** Complete four vertical red-green slices at the confirmed public seams, commit each runnable slice with PLAN updates, verify raw 177/5/503/288 and adjacent corpus users, then run full deterministic/race/vet/frontend/build checks and final Standards/Spec review. Do not rewrite stale source contracts.
