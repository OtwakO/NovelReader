...
- `docs/USER_STORAGE_IMPLEMENTATION_TASKS.md` is the execution checklist. It breaks the accepted design into small completion-gated tasks, records exclusions, and is the source of truth for implementation progress.
