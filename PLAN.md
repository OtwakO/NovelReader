...
**Next action:** Report the completed raw 830/615 shared parser fixes. Final Standards and Spec reviews approved the diff with no blocker or major finding; do not rewrite stale source contracts without approval.
