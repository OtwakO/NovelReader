...
**Next action:** Stop at the approval gate and report v10. Recommended follow-up is a focused test-first fix at the existing Explore rule-selection boundary for the partial-`ruleExplore` fallback seam only; stale sources and URL-pattern enforcement remain unchanged.
