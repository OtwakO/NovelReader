...
**Next action:** Continue with executable source headers, JSON object wildcard/filter selection, and Jsoup `ownText()` after committing the green source-metadata slice. Then verify raw 177/5/503/288 and adjacent corpus users before full checks and review. Do not rewrite stale source contracts.
