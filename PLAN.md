...
**Next action:** Re-run the final spec review after the first reviewer’s usage-limit failure and confirm the shared fragment refactor introduces no standards finding, then report. Do not rewrite raw sources.
