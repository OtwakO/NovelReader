...
**Next action:** Commit the v12 frozen plan, run the 50 identities through a fresh isolated production Explore environment with four-client initial concurrency and 90-second per-page limits, sequentially replay every non-pass, diagnose confirmed failures, preserve JSON/Markdown evidence, and stop for approval without changing source/parser behavior.
