...
**Next action:** Complete the final two-axis code review, address any blocker or major finding, then report the implementation and verification. Do not rewrite raw sources.
