...
### [2026-07-31] Twelfth random Explore sample finds six shared gaps
...
- **Fix**: Confirmed 27 credible identities with 2,768 distinct books and six reusable seams across raws 251, 197, 163, and 17: mobile User-Agent routing, outer non-2xx rule-driven AJAX, missing crypto/login bridge APIs, arbitrary Default attribute getters, singleton bracket indexes, and blank-skipping multi-match attributes. Classified all remaining outcomes without changing behavior.
