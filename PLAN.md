...
1. Continue the accepted [BookSource engine corrections](docs/plans/booksource-engine-compatibility-audit.md), next reassessing remaining evidence and unsupported bridge contracts after the confirmed corrections; retain bounded synthetic and live verification without claiming universal compatibility.
