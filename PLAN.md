...
**Next action:** Continue with Jsoup `ownText()` after committing the green JSON wildcard/filter slice. Then verify raw 177/5/503/288 and adjacent corpus users before full checks and review. Do not rewrite stale source contracts.
