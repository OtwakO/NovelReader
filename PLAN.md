...
**Next action:** Commit the v11 plan and frozen sample, run production Explore for all 50 identities, sequentially confirm every non-pass, diagnose each outcome, preserve evidence, and stop at the approval gate.
