...
**Next action:** Commit the four green TDD slices, rerun exact raws 701/54/220/443 through a fresh production Explore environment, preserve rerun evidence, then run full verification and review.
...
- **Watch out**: Implement one vertical slice at a time, avoid widening unrelated getter/rule behavior, preserve structured HTML behavior, and do not patch stale/upstream sources.
