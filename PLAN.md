...
**Next action:** Commit live rerun evidence and documentation, run full backend deterministic/race/vet and frontend tests/build, then complete Standards/Spec review.
...
- **Watch out**: Keep Unicode rewriting limited to well-formed four-hex Java escapes, dotted wildcard normalization outside quotes, and wildcard-filter support limited to simple existence predicates; richer JSONPath stays delegated. Live reruns return 20 books for raw 66, 14 for raw 57, and 51 for raw 581.
