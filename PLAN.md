...
- **Watch out**: Arbitrary malformed literals are never evaluated; header JavaScript requires an explicit `@js:` prefix, obeys the source timeout, and cannot replace source helper methods.
