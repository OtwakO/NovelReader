...
**Next action:** Commit the encoded page-selector follow-up discovered by raw 503 live verification, restart fresh production verification for raw 177/5/503/288, classify raw 5's later mutable-book-context failure separately, then verify adjacent corpus users before full checks and review. Do not rewrite stale source contracts.
