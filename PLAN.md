...
**Next action:** Verify the approved raw 830/615 shared parser fixes against fresh live pages, complete full deterministic/race/frontend checks, and run final code review. Do not rewrite stale source contracts.
