...
**Next action:** Re-run full verification after tightening simple wildcard predicates to property names only, then complete Spec re-review and close the ninth fixes. Standards review is approved.
