...
**Next action:** Commit two live-rerun corrections: range syntax must participate in Default mode detection, and Explore's configured deadline must override the underlying HTTP client timeout as well as the request context. Restart fresh production and rerun exact raws 701/54/220/443.
