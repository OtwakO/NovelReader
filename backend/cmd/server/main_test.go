...
func TestOpenStoresCreatesCompleteCurrentReaderSchema(t *testing.T) {
	...
	for _, table := range []string{"book_sources", "library_items", "books", "chapters", "bookmarks", "chapter_cache", "fonts", "txt_files", "txt_interpretations", "txt_sections", "txt_inbox_claims"} {
		var count int
