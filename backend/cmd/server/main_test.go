...
func TestOpenStoresCreatesCompleteCurrentReaderSchema(t *testing.T) {
	...
	for _, table := range []string{"book_sources", "library_items", "books", "chapters", "bookmarks", "chapter_cache", "fonts", "txt_files", "txt_interpretations", "txt_sections", "txt_inbox_claims", "epub_files", "epub_preparations", "epub_sections", "epub_resources"} {
		var count int
