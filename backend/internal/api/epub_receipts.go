...
func (s *readerAPI) registerEPUBImportRoutes() {
	...
	register("GET /api/imports/epub/receipts/{id}/navigation", s.handleEPUBPreviewNavigation)
	register("GET /api/imports/epub/receipts/{id}/sections/{section}", s.handleEPUBPreviewSection)
	register("GET /api/imports/epub/receipts/{id}/resources/{resource}", s.handleEPUBPreviewResource)
