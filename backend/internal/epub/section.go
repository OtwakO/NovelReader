...
// Node is a finite semantic tree, never an arbitrary HTML element. The producer
// below is the only constructor; publisher tag names/attributes/styles are not
