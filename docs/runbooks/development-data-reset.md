...
The current epoch is **14** (EPUB storage and shared import lifecycle; EPUB publication/UI remains pending).
Epoch-13 or older homes and archives are not accepted as an in-place upgrade. Preserve that full
