...
The current epoch is **13** (independent last-read tracking on library publications).
Epoch-12 or older homes and archives are not accepted as an in-place upgrade. Preserve that full
