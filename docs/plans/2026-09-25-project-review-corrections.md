...
## Next Action
Finish current architecture/router documentation and mark the correction pass complete. M1 is removed; production scoring/normalization remains tested. Approved M2 formatting is verified.
